...
└── project             # This is where you should do almost everything
    ...
    ├── example.c       # This constain elasticity_solve which will be called.
    │                   # You can change this file, but NOT the function signature.
    ├── fem.c           # you can change this and probably should
    ├── fem.h           # you can also change this
    └── homework.c      # you can also change this
```
...
- Nathan Tihon : par team, ou par email nathan.tihon@uclouvain.be
- Miguel De Le Court : par team, ou par email miguel.delecourt@uclouvain.be
