...
{   
    ...
    geoSetDomainName(9, "Plate left");
    geoSetDomainName(10, "Plate right");
    geoSetDomainName(11, "Plate top");
    geoSetDomainName(12, "Holedown bottom");
    geoSetDomainName(13, "Holedown bottom-left");
    geoSetDomainName(14, "Holedown bottom-right");
    geoSetDomainName(15, "Holedown left");
    geoSetDomainName(16, "Holedown right");
    geoSetDomainName(17, "Holedown top-left");
    geoSetDomainName(18, "Holedown top-right");
    geoSetDomainName(19, "Holedown top");
    geoSetDomainName(20, "Holemid bottom");
    geoSetDomainName(21, "Holemid bottom-left");
    geoSetDomainName(22, "Holemid bottom-right");
    geoSetDomainName(23, "Holemid left");
    geoSetDomainName(24, "Holemid right");
    geoSetDomainName(25, "Holemid top-left");
    geoSetDomainName(26, "Holemid top-right");
    geoSetDomainName(27, "Holemid top");
